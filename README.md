...
<head>
    ...
    <style>
        ...
        h1 {
            font-size: 2em;
            font-family: 'Press Start 2P', cursive; /* Substitua pela fonte desejada */
        ...
        p {
            ...
            text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7); /* Adiciona contorno preto */
            margin-bottom: 10px; /* Reduz a margem inferior das descrições */
            position: relative;
        }
        ...
        p::after {
            ...
            margin-right:10% ;
            display: block;
            margin-top: 1px; /* Adiciona margem acima da seta */
            color: #8e44ad; /* Lilás */
        }
        ...
        button {
            font-size: 1.2em;
            padding: 10px 20px;
            background-color: #7f8c8d; /* Cinza claro */
            color: #ffffff;
            border: none;
            border-radius: 5px;
            cursor: pointer;
...
target="_blank"><button>LIMERCOIN</button></a>
        ...
        <a href="
https://www.miningblocks.club/Referral=70331"target="_blank"><button>MININGBLOCKS</button></a>
        <p>Colete recursos para ganhar recompensas em criptomoedas</p>
        <a href="
https://camelbtc.com/ref=101566"
